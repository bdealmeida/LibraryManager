...
FOR %%x IN ("\Programing\Personal\LibraryManager\webserver\php\PEAR") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=\Programing\Personal\LibraryManager\webserver\php\PEAR"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=\Programing\Personal\LibraryManager\webserver\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=\Programing\Personal\LibraryManager\webserver\php\php.exe"
GOTO :INSTALLED
