...
Step 5: The root directory (main document) f¸r HTTP(S) is => \xampplite\htdocs. PHP files have the extension *.php, SSI *.shtml , CGI *.cgi (e.g. also for Perl scripts), Perl *.pl and ASP *.asp
...
- \xampplite\filezilla\filezilla_installservice.bat
  ===> Install FileZilla as service

- \xampplite\filezilla\filezilla_uninstallservice.bat
  ===> Uninstall FileZilla as service

- \xampplite\mercury\mercury_installservice.bat
  ===> Install Mercury as service

- \xampplite\mercury\mercury_uninstallservice.bat
